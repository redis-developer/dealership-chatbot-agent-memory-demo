  ...
  const features = [
    {
      ...
      description: "We thoroughly inspect each vehicle to ensure its reliability and safety."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Protect your investment with our extended warranty options."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
